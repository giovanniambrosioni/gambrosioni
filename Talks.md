...
<ol reversed>
  <li><i>Introduction to Fukaya TPCs: algebra and geometry</i>, Junior symplectic geometry seminar, ETH Zürich, 25th March 2025.</li>

  <li><i>Triangle inequality for spectral invariants</i>,  <a href="https://math.ethz.ch/news-and-events/events/research-seminars/junior-symplectic-geometry-seminar.html?s=hs24">Junior symplectic geometry seminar</a>, ETH Zürich, 3rd December 2024.</li>

  <li> <i> Generating and split-generating Fukaya categories</i>, <a href="https://math.ethz.ch/news-and-events/events/research-seminars/junior-symplectic-geometry-seminar.html?s=fs23">Junior symplectic geometry seminar</a>, ETH Zürich, 16th May 2023. <button class="abstract-link" onclick="toggleAbstract(this)">Abstract</button><div class="abstract-text">
  ...
  <li> <i>Morse-Bott functions from Moment Maps</i>, <a href="https://math.ethz.ch/news-and-events/events/research-seminars/junior-symplectic-geometry-seminar.html?s=hs22">Junior symplectic geometry seminar</a>, ETH Zürich, 3rd November 2022. <button class="abstract-link" onclick="toggleAbstract(this)">Abstract</button><div class="abstract-text">
  ...
  <li><i> A_infinity-algebras and immersed Floer homology</i>, <a href= "https://math.ethz.ch/news-and-events/events/research-seminars/junior-symplectic-geometry-seminar.html?s=fs21">Junior symplectic geometry seminar</a>, ETH Zürich, 17th May 2021.<button class="abstract-link" onclick="toggleAbstract(this)">Abstract</button><div class="abstract-text">
